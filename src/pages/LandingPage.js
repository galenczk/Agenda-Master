        ...
        <div class="flex mt-10 justify-between">
          ...
          <div class="text-left px-6 py-4 bg-slate-200">
            ...
            <p class="leading-relaxed">
              ...
              <br />
              <br />
              The Update Task form takes in the primary key (task_id) of
              a task and allows a user to update attributes of this task.
              <br />
              <br />
              The Delete Task form takes in the primary key (task_id) of
              a task and deletes it.
            </p>
          </div>
          ...
          <div class="text-left px-6 py-4">
            ...
            <p class="leading-relaxed">
              This page allows a user to interact with the Customers table in the company's
              database.
              <br />
              <br />
              The Add Customer form may be used to add a newly signed customer to our growing list.
              <br />
              <br />
              The Update Customer form takes in the primary key (customer_id) of
              an existing customer and allows a user to update this customer's information.
              <br />
              <br />
              The Delete Customer form takes in the primary key (customer_id) of
              an existing customer and removes them from the database.
            </p>
          </div>
          ...
          <div class="text-left px-6 py-4 bg-slate-200">
            ...
            <p class="leading-relaxed">
              This page allows a user to interact with the Certifications table in the company's
              database.
              <br />
              <br />
              The Add Certification form may be used to add a new certification to the database.
              <br />
              <br />
              The Update Certification form takes in the primary key (certification_id) of
              a certification in the database.
              <br />
              <br />
              The Delete Project form takes in the primary key (project_id) of
              an existing project and deletes this entry from the database.
            </p>
          </div>
        </div>
      </div>
